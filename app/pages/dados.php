...
// === Labels e preços ===
$labels = [
    'inteira' => t('ticket_full'),
    'meia'    => t('ticket_half'),
    'isento'  => t('ticket_free')
];
...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="/bilheteria/public/css/dadosPesson.css">
    <link rel="stylesheet" href="/bilheteria/app/components/VisitanteForm/VisitanteForm.css">
